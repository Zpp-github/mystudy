(function flexible(window, document) {
    ...
    // dpr 物理像素比
    // window.devicePixelRatio 浏览器物理像素比，如果浏览器没有，则令 dpr=1
    ...
    function setBodyFontSize() {
        ...
        if (document.body) {
            ...
            // 如果页面中没有 body 这个元素，则等着页面主要的 DOM 元素加载完毕再去设置 body 的字体大小
    ...
    // reset rem unit on page resize  当页面尺寸大小发生变化的时候，要重新设置下 rem 的大小
